...
window.psswrd = ( function ( window, document, undefined ) {
  ...
  Psswrd.prototype = {
    ...
    init : function () {
      ...
      dataText.innerHTML = '<img src="/rw/SysConfig/WebPortal/BostonGlobe/Framework/images/form-password-eye-show.png" class="form-eye" alt="Show Password" />';
  ...
  var changeFunction = function () {
    ...
    for ( var z = 0; z < labelChildNodes.length; z++ ) {
      ...
      if ( ( self.nodeName.toLowerCase() === 'input' ) && ( self.hasAttribute( 'data-psswrd-toggle' ) ) ) {
        ...
        self.innerHTML = this.checked ? '<img src="/rw/SysConfig/WebPortal/BostonGlobe/Framework/images/form-password-eye-show.png" class="form-eye" alt="Show Password" />' : '<img src="/rw/SysConfig/WebPortal/BostonGlobe/Framework/images/form-password-eye-hide.png" alt="Hide Password" class="form-eye"/>';
      }
    }
